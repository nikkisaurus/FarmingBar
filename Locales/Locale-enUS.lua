...
L.Options_settings_global_misc_newQuickObjectives = "When automatically adding an item (quick objective), choose whether to use existing objectives, overwrite existing objectives, add a new objective, or prompt every time"
L.Options_settings_global_misc_preserveTemplateData = "When loading a saved template, restore button data (objectives, bank inclusion)"
L.Options_settings_global_misc_preserveTemplateOrder = "When loading a saved template, restore the order objectives are placed onto the bar"
