...
L["Add"] = true
L["Add Tracker"] = true
L["Adds template items to the bar without clearing the bar first. *Duplicates are not filtered."] = true
...
L["Preview"] = true
L["Profession Quality Icon"] = true
L["Pushed"] = true
...
L["View Code"] = true
L["Visibility cannot be changed during combat. An attempt may be made once you leave combat; otherwise, try again when out of combat."] = true
L["Warbank"] = true
L["X-Offset"] = true
L["Y-Offset"] = true
