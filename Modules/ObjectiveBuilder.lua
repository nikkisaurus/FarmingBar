...
local function filterAutoItems_OnValueChanged(self, _, value)
    addon:SetDBValue("global", "settings.filterQuickObjectives", value)
    ObjectiveBuilder:RefreshObjectives()
end
...
local methods = {
    ...
    RefreshObjectives = function(self, objectiveTitle)
        ...
        for key, button in pairs(objectiveList.children) do
            ...
            local autoFilterEnabled = addon:GetDBValue("global", "settings.filterQuickObjectives")
...
function addon:Initialize_ObjectiveBuilder()
    ...
    filterAutoItems:SetValue(FarmingBar.db.global.settings.filterQuickObjectives)
